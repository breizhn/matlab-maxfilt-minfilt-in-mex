function y = max_filt(x, filter_length)
% Function to implement a maximum moving window filter.
% It uses the mex function max_min_filt().
%
% ----------------------------------------------------------------------
% Usage: Y = MAX_FILT(X, FILTER_LENGTH)
%
%   input:   ---------
...
y = max_min_filt(x, filter_length, 1);
end
% end of file